...
public class SSMRunner extends JFrame
    ...
    final static int STEP_BY_STEP = 0;
    final static int STEP_CONT_FORWARD = 1;
    final static int STEP_CONT_BACKWARD = 2;
    private final static int SETUP_BUSY = 0;
    private final static int SETUP_READY = 1;
    private static final long serialVersionUID = 1L;
    static Class<?> tableModelColumnClass;
    ...
    JSplitPane codeNStackNHeapSplitPane = new JSplitPane();
    JSplitPane stackNHeapSplitPane = new JSplitPane();
    ...
    JScrollPane heapScrollPane = new JScrollPane();
...
// BEGIN GENERATED CODE
        ...
        memNRestSplitPane.setOrientation(JSplitPane.VERTICAL_SPLIT);
        ...
        statusNOutputSplitPane.setOrientation(JSplitPane.VERTICAL_SPLIT);
        ...
        memNRestSplitPane.add(codeNStackNHeapSplitPane, JSplitPane.TOP);
        memNRestSplitPane.add(statusNOutputSplitPane, JSplitPane.BOTTOM);
        codeNStackNHeapSplitPane.add(codeScrollPane, JSplitPane.LEFT);
        codeNStackNHeapSplitPane.add(stackNHeapSplitPane, JSplitPane.RIGHT);
        codeScrollPane.getViewport().add(codeTable);
        stackNHeapSplitPane.add(stackScrollPane, JSplitPane.LEFT);
        stackNHeapSplitPane.add(heapScrollPane, JSplitPane.RIGHT);
        stackScrollPane.getViewport().add(stackTable);
        heapScrollPane.getViewport().add(heapTable);
        statusNOutputSplitPane.add(statusScrollPane, JSplitPane.TOP);
        statusNOutputSplitPane.add(outputScrollPane, JSplitPane.BOTTOM);
...
// END GENERATED CODE
	...
	*/
    ...
    static class SSMFileFilter extends javax.swing.filechooser.FileFilter {
